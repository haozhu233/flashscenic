...
# GRN inference: 20K-cell subsample for GRN learning (RTX 4090 24GB limit).
# Regulons learned on 20K cells are then scored on the full dataset via AUCell.
# ad_neurons: 424K cells → 20K subsample for GRN, full rescore after.
